...
def ViBu_LTB(choice):# function to call the buzzer and vibration motor. This called from the class StateMachine/function go_to_state
    ...
    if choice == 'Home': # two short
        ...
        drv.play()
        t.sleep(.5)
    elif choice == 'FocusTimer' or choice == 3: # one short one long one short
        t.sleep(.5)
        b.off()
        drv.stop()
        t.sleep(1)
        ...
        drv.play()
        t.sleep(2)
    elif choice == 'P1_Tracking1'# one long one short
        t.sleep(2)
        b.off()
        drv.stop()
        t.sleep(1)
        ...
        drv.play()
        t.sleep(.5)
    elif choice == 'P1_Tracking2'# one short one long
        t.sleep(.5)
        b.off()
        drv.stop()
        t.sleep(1)
        ...
        drv.play()
        t.sleep(2)
    elif choice == 'Profile2' # two shorts one long
        t.sleep(.5)
        b.off()
        drv.stop()
        t.sleep(1)
        ...
        drv.play()
        t.sleep(2)
    elif choice == 'P2_Tracking1' # three shorts
        t.sleep(.5)
        b.off()
        drv.stop()
        t.sleep(1)
        ...
        drv.play()
        t.sleep(.5)
    elif choice == 'P2_Tracking2'# one long two shorts
        t.sleep(2)
        b.off()
        drv.stop()
        t.sleep(1)
...
class P2_Tracking2(State):
    ...
    def pressed(self, machine):
        ...
        if switch_1.is_pressed:
            machine.go_to_state('Home')                                 # Placeholder for a Pause Button & Pause State
        if switch_2.is_pressed:# Little Time Buddy-Integration with Capacitive TFT Screen-Release Code Rev. 4
# 2022-10-09
# CSheeran
# Team 4, CSUS EEE193B
...
while True:
    ...
    switch_2.value                                                      #Checks the switch 2 state each time the loop executes, necessary for button state changes
